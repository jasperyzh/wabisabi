  ...
  <section id="vue-playground">
    <div class="container">
      ...
      <div class="row">
        <div class="col">
          <ul>
            <li v-for="(link, key) in todos" :key="`todo-${key}`">
